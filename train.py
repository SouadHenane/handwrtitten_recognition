...
# dense means fully connected layers, dropout is a technique to improve
# convergence, flatten to reshape our matrices for feeding
# into respective layers
from keras.layers import Dense, Dropout, Flatten
# for convolution (images) and pooling is a technique to help choose the most
# relevant features in an image
...
# For 3D data, "channels_last" assumes
# (conv_dim1, conv_dim2, conv_dim3, channels) while
